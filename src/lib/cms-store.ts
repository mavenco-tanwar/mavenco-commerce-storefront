  ...
  return [
    {
      ...
      type: 'hero',
      title: `Curated Modern Design`,
      subtitle: `Welcome to ${storeName}. High-precision craftsmanship, sustainable materials, and timeless aesthetic silhouettes for the modern lifestyle.`,
      displayOrder: 1,
      isVisible: true,
      settings: {
        tagline: 'Spring / Summer 2026 Collection',
    ...
    },
    {
      ...
      type: 'promotional_banner',
      title: 'Limited Seasonal Celebration',
      subtitle: 'Enjoy 20% off across the complete catalog with code DEMO20 at checkout.',
      displayOrder: 5,
      isVisible: true,
      settings: {
        bannerImage: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?q=80&w=1600&auto=format&fit=crop',
