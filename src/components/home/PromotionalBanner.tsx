...
export function PromotionalBanner() {
  return (
    <section className="relative bg-[#111111] text-white overflow-hidden py-20 md:py-28 select-none">
      ...
      <Image
        src="https://images.unsplash.com/photo-1492707892479-7bc8d5a4ee93?q=80&w=1600&auto=format&fit=crop"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-xl space-y-6">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-[#FFFDFC] leading-tight">
            NEW SEASON.<br />
            <span className="text-[#E8B8B5] italic font-normal">NEW YOU.</span>
          </h2>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-4">
            <Link href="/collections/summer-soiree">
